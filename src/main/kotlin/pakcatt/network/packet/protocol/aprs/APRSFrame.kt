...
/*                   00   Destination            Source                 CTL  PID  TT
    ...
    Example message from VK3LIT-7 to VK2VRO-7 # First transmission
    ...
    Received frame:	 Receive Seq: 5 Send Seq: 7 Delivery Attempt: 0 protocolID: 92 From: VK3LIT-7 to: APY03D-0 controlType: INFORMATION_8 Payload: ��b@b����d@c�:VK2VRO-7 :hello{47
*/
class APRSFrame: KissFrameStandard() {

    private var aprsType: Byte = byteUtils.intToByte(0x00)

    fun populateFromKissFrame(kissFrame: KissFrame) {
    ...
    override fun populateFromFrameData(frameByteData: ByteArray) {
        ...
        if (frameByteData.size >= 18) {
            aprsType = frameByteData[17]
        }
