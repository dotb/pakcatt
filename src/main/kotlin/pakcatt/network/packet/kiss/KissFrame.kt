...
abstract class KissFrame() {
    ...
    enum class ControlFrame(val mask: Int, val bitPattern: Int) {
        ...
        I_8_P(0xFF,0x10),
        I_128(0xFFFF,0x0000),
        I_128_P(0xFFFF,0x0100),

        S_8_RECEIVE_READY(0xFF,0x01), S_8_RECEIVE_NOT_READY(0xFF,0x05), S_8_REJECT(0xFF,0x09), S_8_SELECTIVE_REJECT(0xFF,0x0D),
        S_8_RECEIVE_READY_P(0xFF,0x11), S_8_RECEIVE_NOT_READY_P(0xFF,0x15), S_8_REJECT_P(0xFF,0x019), S_8_SELECTIVE_REJECT_P(0xFF,0x1D),
        S_128_RECEIVE_READY(0xFF,0x0001), S_128_RECEIVE_NOT_READY(0xFF,0x0005), S_128_REJECT(0xFF,0x0009), S_128_SELECTIVE_REJECT(0xFF,0x000D),
        S_128_RECEIVE_READY_P(0xFF,0x0101), S_128_RECEIVE_NOT_READY_P(0xFF,0x0105), S_128_REJECT_P(0xFF,0x0109), S_128_SELECTIVE_REJECT_P(0xFF,0x010D),

        U_SET_ASYNC_BALANCED_MODE(0xFF,0x2F), U_SET_ASYNC_BALANCED_MODE_EXTENDED(0xFF,0x6F), U_DISCONNECT(0xFF,0x43), U_DISCONNECT_MODE(0xFF,0x0F), U_UNNUMBERED_ACKNOWLEDGE(0xFF,0x63), U_REJECT(0xFF,0x87), U_UNNUMBERED_INFORMATION(0xFF,0x03), U_EXCHANGE_IDENTIFICATION(0xFF,0x6F), U_TEST(0xFF,0x73),
        U_SET_ASYNC_BALANCED_MODE_P(0xFF,0x3F), U_SET_ASYNC_BALANCED_MODE_EXTENDED_P(0xFF,0x7F), U_DISCONNECT_P(0xFF,0x53), U_DISCONNECT_MODE_P(0xFF,0x1F), U_UNNUMBERED_ACKNOWLEDGE_P(0xFF,0x73), U_REJECT_P(0xFF,0x97), U_UNNUMBERED_INFORMATION_P(0xFF,0x13), U_EXCHANGE_IDENTIFICATION_P(0xFF,0x7F), U_TEST_P(0xFF,0x83),
