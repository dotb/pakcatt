...
*/
    ...
    private fun handleNewFrame(frame: ByteArray) {
        ...
        if (frame.size >= KissFrame.SIZE_MIN) {
            ...
            logger.debug("Frame from: ${kissFrame.sourceCallsign()} to: ${kissFrame.destCallsign()} control: ${StringUtils.byteToHex(kissFrame.controlField())} controlType: ${kissFrame.controlTypeString()} pollFinalBit: ${kissFrame.pollFinalBitString()} protocolID: ${StringUtils.byteToHex(kissFrame.protocolID())}")
