...
//            mockedTNC.receiveDataCallback(receivedByte)
    ...
    fun testStandardConversationHandshake() {
        ...
        assertResponse(byteArrayFromInts(0x00, 0xac, 0x96, 0x66, 0x98, 0x92, 0xa8, 0xe4, 0xac, 0x96, 0x66, 0x98, 0x92, 0xa8, 0x63, 0x20, 0xf0, 0x48, 0x69, 0x2c, 0x20, 0x74, 0x68, 0x65, 0x72, 0x65, 0x21, 0x20, 0x2a, 0x77, 0x61, 0x76, 0x65, 0x2a, 0xc0), mockedTNC)
