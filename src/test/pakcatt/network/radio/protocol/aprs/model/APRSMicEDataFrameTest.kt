...
class APRSMicEDataFrameTest: TestCase() {
    ...
    fun testPopulateFromFrameData() {
        ...
        */
        ...
        assertEquals("37°40.00' S", aprsMicEDataFrame.latitudeDegreesMinutesHundredths())
        assertEquals("144°50.00' E", aprsMicEDataFrame.longitudeDegreesMinutesHundredths())
    ...
    fun testSpeedAndDirection() {
        ...
        */
        ...
        assertEquals(100, aprsMicEDataFrame.longitudeOffset())
        assertEquals("37°46.06' S", aprsMicEDataFrame.latitudeDegreesMinutesHundredths())
        assertEquals("144°57.22' E", aprsMicEDataFrame.longitudeDegreesMinutesHundredths())
