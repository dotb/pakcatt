...
class ScriptableAppTest : TestCase() {
    ...
    fun testConnectionRequestSuccessWithMessage() {
        val validConnectionRequest = AppRequest("REM1C", "MYCALL","MYCALL", "date")
    ...
    fun testConnectionRequestSuccessWithACK() {
        val validConnectionRequest = AppRequest("REM1C", "MYCALL", "MYCALL", "ack")
    ...
    fun testConnectionRequestSuccessWithIgnore() {
        val validConnectionRequest = AppRequest("REM1C", "NOTMYCALL", "NOTMYCALL", "ignore me")
