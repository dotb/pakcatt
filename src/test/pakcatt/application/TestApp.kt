...
class TestApp: RootApp() {
    ...
    override fun handleReceivedMessage(request: LinkRequest): InteractionResponse {
        return when (stringUtils.removeEOLChars(request.message)) {
            ...
            else ->  InteractionResponse.sendText("Testing, 1, 2, 3")
        }
    }
