...
class APRSServiceTest : ProtocolTest() {
    ...
    fun `test messages with ACK numbers`() {
        ...
        */
        ...
        assertEquals("AppRequest(remoteCallsign=VK3LIT-7, remoteCallsignWithoutSSID=VK3LIT, addressedToCallsign=VK3LIT-1, message=last, viaRepeaterOne=APRSAT-0, viaRepeaterTwo=WIDE2-1, canReceiveMessage=true, location=null, userContext=null)", appInterface.receivedAppRequest.toString())
    }
